...
class EmailService {
  ...
  async sendTeamSelectionEmail(
    ...
    const html = `
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>Congratulations! You are Selected! 🎉</h1>
            </div>
            <div class="content">
              <p>Great news!</p>
              <p>Your team <strong>${team.teamName}</strong> has been officially selected to participate in SUST CSE Carnival 2026 for the <strong>${team.segment}</strong> segment.</p>
              
              <div class="team-info">
                <p>To confirm your participation, please complete your team's payment using the unique link below.</p>
              </div>
              ...
              <p style="color: #666; font-size: 14px;"><em>Or copy and paste this link: ${paymentLink}</em></p>
              
              <p>We look forward to seeing you at the event!</p>
              
              <div class="footer">
                <p>SUST CSE Carnival 2026<br>This is an automated email.</p>
              </div>
            </div>
          </div>
        </body>
    ...
    await this.sendEmail({
      to: recipients,
      subject: `Action Required: ${team.teamName} Selected for SUST CSE Carnival 2026!`,
      html,
    });
  }
}
